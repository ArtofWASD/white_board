    ...
    <div className="flex flex-col items-center justify-center min-h-[50vh] w-full bg-white rounded-3xl p-8 shadow-xl border border-gray-100 space-y-8">
      ...
      <div className="flex w-full justify-between items-end px-4 text-gray-500 font-mono">
        ...
        <div className="flex flex-col items-end">
          ...
          <span className="text-2xl font-bold text-gray-800">{displayRounds}</span>
        </div>
      </div>
      ...
      {hasRoundTimes && (
        <div className="w-full mt-4 border-t border-gray-100 pt-4">
          <h3 className="text-sm uppercase tracking-widest text-gray-400 mb-3 text-center">
            Время по раундам
          </h3>
          <div className="flex flex-col gap-2">
            {roundTimes.map((rec: RoundRecord, idx: number) => {
              ...
              return (
                <div
                  key={rec.round}
                  className="flex justify-between items-center px-4 py-2 bg-purple-50 rounded-xl border border-purple-100">
                  <span className="font-bold text-purple-700">Раунд {rec.round}</span>
