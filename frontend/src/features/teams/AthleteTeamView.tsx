...
const AthleteTeamView: React.FC<
  AthleteTeamViewProps & {
    isTrainer?: boolean
...
> = ({ teams, isTrainer, onRemoveMember, onEditTeam, onDeleteTeam, onLeaveTeam }) => {
  ...
  const handleOpenChat = async (team: Team) => {
                    ...
                    <div className="flex items-center gap-1">
                      {onEditTeam && (
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:text-white dark:hover:bg-gray-800 rounded-full transition-all flex-shrink-0"
                      ...
                      {onDeleteTeam && (
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:text-red-400 dark:hover:bg-gray-800 rounded-full transition-all flex-shrink-0"
                      ...
                      {isTrainer && onRemoveMember && member.role !== "OWNER" && (
                        <button
                          ...
                          onClick={(e) => {
                            ...
                            if (
                              confirm(
                                `Вы уверены, что хотите удалить ${member.user.name} из команды?`,
                              )
                            ) {
