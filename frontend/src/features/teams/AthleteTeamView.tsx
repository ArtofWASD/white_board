          ...
          <div className="p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {team.members?.map((member) => (
                <div 
                  key={member.id} 
                  className="flex items-center p-4 rounded-xl bg-gray-50 border border-gray-100 hover:border-blue-300 hover:bg-white transition-all duration-200 group shadow-sm hover:shadow-md"
                >
