  ...
  if (!exercise) {
      return (
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <div className="flex-grow flex items-center justify-center">
               <div className="text-center">
                   <h2 className="text-2xl font-bold text-gray-900 mb-2">Упражнение не найдено</h2>
                   <Link href="/blog/exercises" className="text-indigo-600 hover:text-indigo-800">
                       Вернуться к списку
                   </Link>
               </div>
            </div>
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="mb-6">
              <Link href="/blog/exercises" className="text-indigo-600 font-medium hover:text-indigo-800 flex items-center">
                           ...
                           {exercise.muscleGroups && exercise.muscleGroups.length > 0 && (
                               <div className="flex flex-wrap gap-2 mt-2">
                                   {exercise.muscleGroups.map(mg => (
                                       <span key={mg} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
