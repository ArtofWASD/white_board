                        ...
                        {notifications.map((notification) => (
                            ...
                            >
                                <div className={`mt-1 p-2 rounded-full flex-shrink-0 ${
                                    notification.type === 'LIKE' ? 'bg-pink-100 text-pink-500' : 'bg-blue-100 text-blue-500'
                                }`}>
                                ...
                                <div className="ml-4 flex-1">
                                    <p className={`text-base leading-relaxed ${notification.isRead ? 'text-gray-700' : 'text-gray-900 font-medium'}`}>
